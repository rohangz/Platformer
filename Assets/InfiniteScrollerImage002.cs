...
public class InfiniteScrollerImage001 : MonoBehaviour {
...
//		for (int i = 0; i < gameObject.transform.childCount; i++)
	...
	void Update () {
		...
		GameObject o1 = GameObject.FindGameObjectWithTag ("alpha");
		GameObject o2 = GameObject.FindGameObjectWithTag ("alpha");
